...
const Cards = () => {
    let cardInfo = [
        ...
        {title: "Titulo2", text: "Bacon ipsum dolor amet kielbasa ground round salami cow. Bresaola jerky pork chop tongue porchetta."},
        {title: "Titulo3", text: "Ball tip turkey tenderloin tail pork loin, pastrami buffalo boudin ham hock. Corned beef turkey."},
        {title: "Titulo4", text: "Cow tenderloin tongue cupim jerky beef ribs chicken buffalo pig jowl kielbasa. Alcatra cow brisket."},
     ]
    return (
    <>
        {cardInfo.map((card) =>{
